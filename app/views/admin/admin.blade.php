        ...
        <div class="row">
            ...
            <div class="span9">
                ...
                <section id="featured">
                    ...
                    <form class="form-horizontal" method="post" action="{{ URL::route('adminRegister')  }}" enctype="multipart/form-data">
                      @if (Session::has('success'))
                       ...
                       <h3 class="heading3">Your Personal Details</h3>
                        ...
                        <label for="admin_pin" class="control-label"><span class="red">*</span> Admin pin:</label>
                         <div class="controls">
                         <input id="password" name="admin_pin" type="password" class="input-xlarge">
                         </div>
                         </div>
                        </fieldset>
            </div>
